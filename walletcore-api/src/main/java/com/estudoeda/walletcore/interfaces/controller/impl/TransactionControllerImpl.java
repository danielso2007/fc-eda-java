...
public class TransactionControllerImpl implements TransactionController {
    ...
    public TransactionControllerImpl(TransactionService transactionService,
            TransactionAdapterMapper transactionAdapterMapper) {
    ...
    public ResponseEntity<TransactionResponseDto> realizar(
            @Valid TransactionCreateRequestDto transactionCreateRequestDto) {
        logger.info("Iniciando transação...");
        var transaction = transactionService.create(transactionCreateRequestDto.getAccountFromId(),
                transactionCreateRequestDto.getAccountToId(), transactionCreateRequestDto.getAmount());
